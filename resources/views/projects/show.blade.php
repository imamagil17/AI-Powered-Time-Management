                ...
                <div class="p-6 text-gray-900 dark:text-textlight">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div class="md:col-span-2">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-textlight mb-2">Deskripsi Proyek</h3>
                        ...
                        <div>
                            <div class="bg-gray-50 dark:bg-secondary p-4 rounded-lg">
                                <h4 class="font-medium text-gray-900 dark:text-textlight mb-2">Detail Proyek</h4>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex">
                                        <span class="font-medium text-gray-700 dark:text-gray-300 w-32">Tanggal Mulai:</span>
                                        <span class="text-gray-600 dark:text-gray-300">
                                            {{ $project->start_date ? \Carbon\Carbon::parse($project->start_date)->format('d M Y') : 'Belum ditentukan' }}
                                        </span>
                                    </div>
                                    
                                    <div class="flex">
                                        <span class="font-medium text-gray-700 dark:text-gray-300 w-32">Tenggat:</span>
                                        <span class="text-gray-600 dark:text-gray-300">
                                            {{ $project->due_date ? \Carbon\Carbon::parse($project->due_date)->format('d M Y') : 'Belum ditentukan' }}
                                        </span>
                                    </div>
                                    
                                    <div class="flex">
                                        <span class="font-medium text-gray-700 dark:text-gray-300 w-32">Total Tugas:</span>
                                        <span class="text-gray-600 dark:text-gray-300">{{ $project->tasks->count() }}</span>
                                    </div>
                                    
                                    <div class="flex">
                                        <span class="font-medium text-gray-700 dark:text-gray-300 w-32">Tugas Selesai:</span>
                                        <span class="text-gray-600 dark:text-gray-300">{{ $project->tasks->where('status', 'completed')->count() }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-6 flex justify-between items-center">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-textlight">Tugas dalam Proyek</h3>
                        
                        <a href="{{ route('tasks.create.project', ['project' => $project->id]) }}" 
                    ...
                    @else
                        <div class="text-center py-8">
                            <p class="text-gray-500 dark:text-gray-400">Belum ada tugas dalam proyek ini.</p>
                            <a href="{{ route('tasks.create.project', ['project' => $project->id]) }}" 
