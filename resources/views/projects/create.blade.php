                    ...
                    <form method="POST" action="{{ route('projects.store') }}">
                        ...
                        <div class="mb-4 animate-graceful" style="animation-delay: 0.2s;">
                            ...
                            <textarea name="description" id="description" 
                                      rows="4" 
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-secondary dark:text-white">{{ old('description') }}</textarea>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                Deskripsi proyek akan digunakan untuk menghasilkan tugas-tugas otomatis menggunakan AI.
                            </p>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
